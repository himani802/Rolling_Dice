...
let z=0
 ...
 function roll_dice() {
    ...
    var audio = new Audio('dice_sound.mp3')
    audio.play()

    let randomNumber = Math.floor(Math.random() * 6) + 1;
    document.getElementById("dice_value").innerHTML = randomNumber;
...
window.onload = function() {
    ...
    window.poof = poof;  // Make poof function globally accessible
};